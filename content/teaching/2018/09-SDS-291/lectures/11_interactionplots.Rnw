...
As an example, consider Figure \ref{atlantic}, from \url{https://www.theatlantic.com/health/archive/2018/10/the-only-chore-men-will-do-is-cook/505067/}
...
<<size='footnotesize',fig.width=6, fig.height=4, message=FALSE>>=
require(openintro)
